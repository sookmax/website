...
Finally, it was time that I confronted [LeetCode](https://leetcode.com/) again, but this time I was better prepared, having just finished extensive data structures and algorithms (DSA) study for the first time in my life 💪. In particular, I followed this wonderful curated list of 150 LeetCode problems, called [NeetCode 150](https://neetcode.io/practice).
