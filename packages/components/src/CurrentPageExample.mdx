...
In the beginning of May. 2023, I finally decided to take a look at <a href="https://storybook.js.org/docs/react/get-started/why-storybook" target="_blank">Storybook</a>. I'd seen it being mentioned by web devs on the internet many times (mostly positive), and some even argued Storybook was an indispensable tool when it comes to UI component development.
...
There was an online game that I used to enjoy playing&mdash;<a href="https://teamfighttactics.leagueoflegends.com/en-us/" target="_blank">Teamfight Tactics (TFT)</a>. So naturally I had been checking out <a href="https://developer.riotgames.com/apis" target="_blank">Riot's APIs</a> to see if I could create something fun or useful with them.
