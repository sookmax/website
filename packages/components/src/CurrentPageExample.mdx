...
<h2 id="interview-prep-job-search-loop" className="scroll-mt-24">
  <span className="not-prose">
    ...
    >
      {"Interview prep & job search loop"}
    </a>
  </span>
</h2>
...
<Event date="2024-06">
<h2 id="reading-ddia" className="scroll-mt-24">
  <span className="not-prose">
    <a
      href="#reading-ddia"
      className="relative before:content-['#'] before:invisible before:hover:visible before:absolute before:right-full before:mr-1 before:opacity-50"
...
<h2 id="contributing-to-react-aria" className="scroll-mt-24">
  <span className="not-prose">
    <a
