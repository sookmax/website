import { Article, Timeline } from "./mdx";

export default function Layout({ children }) {
  return (
    <div className="relative">
      <Timeline />
      <div className="relatve">{children}</div>
    </div>
  );
}

<Article date="2023-10" />
<Article date="2023-09" />
<Article date={'2023-08'}>
...
<Article date="2023-04" />
<Article date="2023-03" />
<Article date="2023-02" />
