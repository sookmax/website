...
<StickyEventHeader id="fe-3i" className="flex justify-between scroll-mt-24">
...
<StickyEventHeader id="fe-dawin" className="flex justify-between scroll-mt-24">
  <span className="not-prose">
    <a
      href="#fe-dawin"
      className="relative before:content-['#'] before:invisible before:hover:visible before:absolute before:right-full before:mr-1 before:opacity-50"
...
<StickyEventHeader
  id="swe-agilesoda"
  className="flex justify-between scroll-mt-24"
>
  <span className="not-prose">
    <a
      href="#swe-agilesoda"
...
<StickyEventHeader id="college" className="flex justify-between scroll-mt-24">
  <span className="not-prose">
    <a
      href="#college"
      className="relative before:content-['#'] before:invisible before:hover:visible before:absolute before:right-full before:mr-1 before:opacity-50"
