  ...
  return (
    <div className="prose dark:prose-invert max-w-none">
      ...
      <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
        ...
        around 2019-2020&mdash;everything before that is my data analysis
        career.
      </p>
...
At least I learned a lot about 3D graphics in this period, while working on the complete rewrite of the company's JavaScript 3D engine&mdash;something very similar to Google Street View. It was a daunting task that felt impossible at first, but I managed to come up with two(!) versions of the rewrite, each accompanied with a fairly thorough documentation at the end&mdash;[three.js manual](https://threejs.org/manual/#en/fundamentals) and books like [Introduction to Computer Graphics](https://math.hws.edu/graphicsbook/index.html) helped me grasp the core ideas of computer graphics immensely, and I should also mention that [Three.js journey](https://threejs-journey.com/) helped me organize the structure of the codebase a lot.
